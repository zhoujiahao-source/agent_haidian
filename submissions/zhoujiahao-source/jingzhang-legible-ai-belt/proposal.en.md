---
title: "Jing-Zhang Urban Capability Exchange / 京张·城市能力交换带"
...
![Evidence tiers, Capability Backbone and Open Node overview](assets/figures/site-overview.en.png)
...
![Land-use structure and the spatial transfer from backbone to learning units](assets/figures/land-use-structure.en.png)
...
![Slow-mobility stitches, rail continuity, blue-green network and public services](assets/figures/mobility-bluegreen.en.png)
...
![UAR, evidence confidence, public-value floors and governance loop](assets/figures/metrics-evidence.en.png)
